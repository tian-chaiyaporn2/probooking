...
export const th = {
  ...
  journey: {
    ...
    stepDetail: {
      ...
      accept: "บุคลากรตรวจเงื่อนไขแล้วยอมรับ (กันเงินไว้ — ยังไม่ใช่การจอง)",
      confirm: "คลินิกยืนยันหลังคุ้มครองเงิน → การจองเป็น Confirmed",
  ...
  ops: {
    ...
    verifyConfirmBody: (name: string, kind: string) =>
      `ตรวจสอบ「${name}」(${kind}) แล้วเปลี่ยนสถานะเป็น Verified — การกระทำนี้ผูกพัน`,
  ...
  finance: {
    ...
    refund: "คืนเงิน",
    refundTitle: "คืนเงิน (ต้องมีผู้อนุมัติสองคน §6.4)",
