  ...
  webServer: [
    {
      ...
      env: {
        ...
        STAFF_PHONES:
          ...
          "+66900000004:finance,+66900000005:finance,+66900000006:finance,+66900000008:operations,+66900000009:operations," +
          ...
          // dedicated to the filled-content ops-detail wrap test (own phone → no OTP clash):
          "+66900000024:operations",
