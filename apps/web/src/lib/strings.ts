...
export const th = {
  ...
  home: {
    ...
    description:
      "Phase 0 เป็น concierge ทีม ProBooking ช่วยจองให้ครบวงจร หน้านี้แสดงเส้นทางธุรกรรมและเครื่องมือทีมภายใน ไม่ใช่ตลาดจองด้วยตนเองแบบเต็มรูปแบบ",
    phase: "Phase 0 concierge กรุงเทพฯ และปริมณฑล",
    metadataDescription:
    ...
    audienceClinicDesc:
      "ใน Phase นี้ ทีม concierge ช่วยประกาศเวร จอง และยืนยันการชำระเงินให้",
    ...
    open: "เปิด",
    contactNote:
      "สนใจใช้งานจริงใน Phase 0? ติดต่อทีม concierge เรายังไม่เปิดจองด้วยตนเองสาธารณะ",
  },
  flow: {
  ...
  signin: {
    ...
    reset: "รีเซ็ตข้อมูล demo",
    resetDone: "รีเซ็ตข้อมูล demo แล้ว พร้อมเข้าสู่ระบบใหม่",
  },
  journey: {
    title: "เส้นทางจอง",
    subtitle:
  ...
  nav: {
    ...
    ops: "ปฏิบัติการ",
    finance: "การเงิน",
    // Label follows #41 loanword policy ("Demo"). Whether /flow stays in primary
    // nav is a separate product decision — see merge conflict report.
    flow: "Demo",
    signin: "เข้าใช้งาน",
    publicGroup: "สาธารณะ",
    staffGroup: "ทีมภายใน",
  ...
  party: {
    ...
    confirmPay: "ยืนยันและกันเงิน",
    myBookings: "การจอง",
    noBookings: "ยังไม่มีการจอง",
    acceptPayout: "รับงานและจ่ายเงิน",
    cancel: "ยกเลิก",
